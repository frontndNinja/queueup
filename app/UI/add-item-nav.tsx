...
export default function AddItemNav({ queueId, user, moviesAndSeries }: { queueId: string; user: User; moviesAndSeries: EntryWithRelationsAndVotes[]; searchUrl: string; }) {
                ...
                <ModalPortal>
                    <div className="absolute top-0 left-0 right-0 bottom-0 z-100 w-screen h-screen bg-background/50">
                        <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center p-4">
                            <div className="w-full max-w-[80vw] max-h-[80vh] overflow-y-auto rounded-md bg-lighter-background p-4">
